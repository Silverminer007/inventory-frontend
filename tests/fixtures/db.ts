...
export const TEST_CONTAINERS = [
  { id: TEST_IDS.KELLER,         name: 'Keller',         containerType: 'ROOM',  parentContainerId: null,             version: 0, itemCount: 2, totalItemCount: 3 },
  { id: TEST_IDS.WERKZEUG_REGAL, name: 'Werkzeug-Regal', containerType: 'SHELF', parentContainerId: TEST_IDS.KELLER,  version: 0, itemCount: 1, totalItemCount: 1 },
  { id: TEST_IDS.KLEINE_KISTE,   name: 'Kleine Kiste',   containerType: 'BOX',   parentContainerId: TEST_IDS.WERKZEUG_REGAL, version: 0, itemCount: 1, totalItemCount: 1 }
]

export const TEST_ITEMS = [
  { id: TEST_IDS.HAMMER,          name: 'Hammer',          containerId: TEST_IDS.WERKZEUG_REGAL, tags: ['Werkzeug'],          quantity: 1, version: 1 },
  { id: TEST_IDS.SCHRAUBENZIEHER, name: 'Schraubenzieher', containerId: TEST_IDS.KLEINE_KISTE,   tags: ['Werkzeug', 'Klein'], quantity: 2, version: 1 }
]
